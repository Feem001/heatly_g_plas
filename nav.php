...
?>
  ...
  <div class="bg-secondary p-2">
    ...
    <div class="">
    <nav class="navbar navbar-brand  shadow-sm">
          <div class="container">
          <img src="รอบภาค/โลโก้/โลโก้เต็ม.png" width="180px" alt="">
               <ul class="nav">
                    <li class="nav-item"><a href="user.php" class="nav-link  li-btn text-dark"><img src="รอบภาค/ไอคอน/หน้าแรก2.png" width="30px" alt="">หน้าแรก</a></li>
